...
<body class="bg-gray-900">
    <div class="flex justify-between container mx-auto my-8 px-4 py-8 bg-slate-700 relative">
        ...
        <div class="text-white text-lg">
            ...
            <a class="mr-10 @yield('register-active') px-2 py-1" href="{{url('user/register-user')}}">Register</a>
            <a class="mr-10 @yield('login-active') px-2 py-1" href="{{url('user/login-user')}}">Log in</a>
