...
<div class="container flex rounded-lg bg-slate-700 p-4 mx-auto my-14">
    ...
    @endforeach -->
        <div class="form-group m-3">
            <div class="flex">
            <label class="text-white text-xl flex-row mx-auto" for="tag1">Tag 1</label><label class="text-white text-xl flex-row mx-auto" for="color1">Color 1</label>
            </div>
            
            <input type="text"  class="form-control mt-2 px-3 py-2 rounded-lg w-96" name="tags[1][name]" value=""> <!-- hier de values die van al bestaande tags zijn -->
            <select class="form-control mt-2 px-3 py-2 rounded-t-lg w-48" name="tags[1][color]" id="color1">
        ...
        <div class="form-group m-3">
        <div class="flex">
            <label class="text-white text-xl flex-row mx-auto" for="tag2">Tag 2</label><label class="text-white text-xl flex-row mx-auto" for="color2">Color 2</label>
            </div>
            
            <input type="text" class="form-control mt-2 px-3 py-2 rounded-lg w-96" name="tags[2][name]" value="">
            <select class="form-control mt-2 px-3 py-2 rounded-t-lg w-48" name="tags[2][color]" id="color2">
                <option style="background-color: #000; color: #FFF;" value="#000">Black</option> 
                <option style="background-color: #FFF; color: #000;" value="#FFF">White</option>
                <option style="background-color: #09F;" value="#09F">Blue</option>
                <option style="background-color: #C00;" value="#C00">Red</option>
        ...
        <div class="form-group m-3">
        <div class="flex">
            <label class="text-white text-xl flex-row mx-auto" for="tag3">Tag 3</label><label class="text-white text-xl flex-row mx-auto" for="color3">Color 3</label>
            </div>
            
            <input type="text" class="form-control mt-2 px-3 py-2 rounded-lg w-96" name="tags[3][name]" value="">
            <select class="form-control mt-2 px-3 py-2 rounded-t-lg w-48" name="tags[3][color]" id="color3">
                <option style="background-color: #000; color: #FFF;" value="#000">Black</option> 
                <option style="background-color: #FFF; color: #000;" value="#FFF">White</option>
                <option style="background-color: #09F;" value="#09F">Blue</option>
                <option style="background-color: #C00;" value="#C00">Red</option>
